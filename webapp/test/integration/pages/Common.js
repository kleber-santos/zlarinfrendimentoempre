sap.ui.define([
	...
	return Opa5.extend("whr.com.br.ZLARInfRendimentoEmpre.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["whr/com/br/ZLARInfRendimentoEmpre/localService/mockserver"], function (mockserver) {
